...
namespace Ekip.Application.Features.Authentication.Queries.Login
{
    public class LoginQueryHandler : IRequestHandler<LoginQuery, AuthenticationResult>
    {
        ...
        public LoginQueryHandler(IUserWriteRepository userWrite, IPasswordHasher passwordHasher, IJwtTokenGenerator jwtTokenGenerator, IRedisCacheService redisCache)
        {
        ...
        public async Task<AuthenticationResult> Handle(LoginQuery request, CancellationToken cancellationToken)
        {
            ...
            var user = await _userWrite.GetUserByUserNameOrEmailAsync(request.UserName, request.Email,cancellationToken);
