...
namespace Ekip.Application.Interfaces
{
    public interface IRequestReadRepository
    {
        ...
        Task<List<MyEkipDto>> GetEkipsByUserIdAsync(Guid userRef, CancellationToken cancellationToken);
        Task<List<PendingAssignmentsDto>> GetPendingAssignmentByUserIdAsync(Guid userRef, CancellationToken cancellationToken);
